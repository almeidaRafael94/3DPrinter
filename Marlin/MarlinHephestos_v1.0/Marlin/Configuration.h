...
#define STRING_VERSION_CONFIG_H __DATE__ "13/02/2017 2042h" __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(Rafael Almeida, NERD)" // Who made the changes.
...
// Select PID or bang-bang with PIDTEMPBED. If bang-bang, _LIMIT_SWITCHING will enable hysteresis
//
