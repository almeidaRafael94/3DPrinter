...
#define STRING_VERSION_CONFIG_H __DATE__ "22/02/2017 : 23:27 " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(Rafael Almeida)" // Who made the changes.
...
const bool X_MIN_ENDSTOP_INVERTING = true; // eixo do extrusor false para optico
const bool Y_MIN_ENDSTOP_INVERTING = true; // plataforma
...
#define WITBOX
    ...
    #define PREHEAT_FAN_SPEED 100
    #define COOLDOWN_FAN_SPEED 255
#endif

#if defined(ENABLE_AUTO_BED_LEVELING) || defined(WITBOX)
  #define XY_TRAVEL_SPEED 6000 		// X and Y axis travel speed between probes and Witbox movements, in mm/min
#endif
//===========================================================================
//=============================Additional Features===========================
//===========================================================================
